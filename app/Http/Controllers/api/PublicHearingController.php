...
use App\Http\Resources\PublicHearing\PublicHearingResource;
use App\Http\Resources\PublicHearing\PublicHearingListResourceCollection;
...
class PublicHearingController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $hearing = PublicHearing::where($wheres)->orderBy('id','desc')->paginate(10);

        $data = new PublicHearingListResourceCollection($hearing);
    ...
    public function show($id)
    {
        ...
        $hearing = PublicHearing::find($id);

        if (is_null($hearing)) {
			return $this->jsonErrorResourceNotFound();
        }

		$data = new PublicHearingResource($hearing);
